    ...
    Begin
        ...
        If sz > hl Then
            Try
                ...
                Pad.HoleWidth := sz;
                { Угол в задании отсчитан ОТ ПЛОЩАДКИ: Altium крутит
                  отверстие вместе с ней, HoleRotation складывается с
                  Pad.Rotation. Поэтому 0 -- это «паз вдоль площадки», и
                  трогать свойство незачем. Если у этой сборки Altium его
                  нет, обычные пазы всё равно построятся. }
